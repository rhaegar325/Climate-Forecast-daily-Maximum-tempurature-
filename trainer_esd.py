...
from model import vdsr, ESPCNNet
...
import time
from util.PrepareData import ACCESS_AGCD_vdsr
...
def train_main():
    ...
    # hyper-parameters
    parser.add_argument('--train_name', type=str, default="Ynet_tmax_esd", help='training name')
...
#         args.file_BARRA_dir="C:/Users/JIA059/barra/"
    ...
    data_set=ACCESS_AGCD_vdsr(args.start_date,args.end_date,lr_transform=lr_transforms,hr_transform=hr_transforms,args=args)
    if args.test:
        print(1)
    else:
        ...
        device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
        net=ESPCNNet(input_channels=1,output_channels=1,upscale_factor=8)
        #checkpoint=torch.load("./save/Ynet_tmax_dem_up2/best_train_80.pth")
