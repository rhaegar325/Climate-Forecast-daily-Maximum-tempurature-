...
from model import vdsr, REDNet30
...
def train_main():
    ...
    # hyper-parameters
    parser.add_argument('--train_name', type=str, default="Rednet", help='training name')
...
#         args.file_BARRA_dir="C:/Users/JIA059/barra/"
    ...
    if args.test:
        ...
        device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
        net=REDNet30(num_layers=15,input_channels=1,output_channels=1)
